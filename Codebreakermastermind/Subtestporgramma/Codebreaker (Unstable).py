...
def AIGokCode():
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~      Dit is een random nummer gokker met geen logica     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~      GameGokcode moet een list van 4 elementen zijn      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    GameGokcode = [ListKleurenNamen[random.randrange(AantalKleuren)], ListKleurenNamen[random.randrange(AantalKleuren)],
                   ListKleurenNamen[random.randrange(AantalKleuren)], ListKleurenNamen[random.randrange(AantalKleuren)]]
    return GameGokcode
...
def ControlleCode(gegokte_code, kraakcode):
    Blackpin = 0
    Whitepin = 0
    Collourblindpin = 0
...
def aibraincode(mainlist):
    ...
    for i in range(len(mainlist)):
        AITestuitkomst = ControlleCode(mainlist[i],mainlist[0])
...
for i in range(0, AantalRondes):
    if AIGokCodeBool == True:
        if AIKeuzeAlg == 0:
            ...
            print(mainlist[0])
            GokUitkomst = ControlleCode(mainlist[0],GlobalGokcode)
